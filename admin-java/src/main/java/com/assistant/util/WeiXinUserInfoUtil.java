...
public class WeiXinUserInfoUtil {
    ...
    // 1.获取code的请求地址
    public static String Get_Code = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=%s&redirect_uri=%s&response_type=code&scope=%s&state=STATE&connect_redirect=1#wechat_redirect";
    // 替换字符串
    ...
    public static void main(String[] args) {
        String REDIRECT_URI = "https://elite.ztch.ltd/elite/web/url";
        String SCOPE = "snsapi_userinfo";

        //appId
        String appId = "wxba910f5e3302cc03";
