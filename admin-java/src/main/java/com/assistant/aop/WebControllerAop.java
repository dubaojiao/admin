...
import com.assistant.domain.mongodb.SysLog;
import com.assistant.domain.redis.LoginUser;
import com.assistant.pojo.ApiResult;
import com.assistant.task.AsyncTaskService;
import com.assistant.util.CheckUtil;
import com.assistant.util.JSONUtil;
...
public class WebControllerAop {
    ...
    @Autowired
    UserCacheComponent cacheComponent;

    //匹配com..xchxin.simons.controller包及其子包下的所有类的所有方法
    @Pointcut("execution(* com.assistant.controller..*.*(..))")
